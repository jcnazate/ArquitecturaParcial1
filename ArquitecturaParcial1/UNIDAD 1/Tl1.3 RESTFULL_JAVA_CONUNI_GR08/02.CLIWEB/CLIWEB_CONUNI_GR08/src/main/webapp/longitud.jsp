...
<style>
:root{ --c1:#05abda; --c2:#b2c7db; --c3:#6c5494; }
...
<body>
  ...
  <section class="card" role="region" aria-label="Conversión de longitud">
    <h1 class="title">CONVERSIÓN DE LONGITUD</h1>
    <p class="subtitle">De centímetros a pulgadas y de pulgadas a centímetros</p>
    ...
    <div class="section" id="cmToIn">
      ...
      <form action="RestController" method="post" autocomplete="off">
        ...
        <input type="hidden" name="tipo" value="centimetrosAPulgadas">
    ...
    <div class="section" id="inToCm">
      ...
      <form action="RestController" method="post" autocomplete="off">
        <input type="hidden" name="action" value="longitud">
        <input type="hidden" name="tipo" value="pulgadasACentimetros">
