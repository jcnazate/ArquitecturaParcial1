...
<body>
  ...
  <section class="menu-card" role="region" aria-label="Menú principal">
    ...
    <div style="margin-top: 20px; text-align: center;">
      <form action="RestController" method="post" style="display: inline;">
        <input type="hidden" name="action" value="logout">
        <button type="submit" class="btn" style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); box-shadow: 0 10px 28px rgba(239,68,68,.35);">
          Cerrar Sesión
        </button>
      </form>
    </div>
